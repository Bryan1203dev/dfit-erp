...
const Modal: React.FC<ModalProps> = ({ isOpen, onClose, onConfirm, title, message, type = 'confirm', children }) => {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-neutral-800 w-full max-w-md rounded-2xl border-2 border-red-600 shadow-[0_0_40px_rgba(220,38,38,0.35)] overflow-hidden transform transition-all scale-100">
        ...
        <div className="p-6 text-center">
            <div className="mb-4 flex justify-center">
                {/* Circular branded logo container with intense red border & neon glow */}
                <div className="w-16 h-16 rounded-full flex items-center justify-center overflow-hidden border-2 border-red-600 shadow-[0_0_20px_rgba(220,38,38,0.45)] bg-neutral-900">
                    <img 
            ...
            <div className="flex gap-3 justify-center">
                ...
                <button 
                    ...
                    className="px-6 py-2 rounded-xl bg-gradient-to-r from-red-800 to-red-600 text-white font-bold hover:shadow-lg hover:shadow-red-500/25 transition-all"
                >
