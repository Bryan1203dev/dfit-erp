                ...
                <div className="flex gap-2 items-center">
                  <div className="flex-1">
                    ...
                    <input
                      ...
                      placeholder="0.00"
                      className="w-full p-2 text-sm rounded border border-purple-300 dark:border-purple-600 bg-gray-800 text-white focus:outline-none focus:ring-1 focus:ring-purple-500 text-right font-bold"
                    />
                  </div>
                  <div className="flex-1">
